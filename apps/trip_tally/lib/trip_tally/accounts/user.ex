defmodule TripTally.Accounts.User do
  @moduledoc false
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, TripTally.Repo)
  ...
  """
  def valid_password?(%TripTally.Accounts.User{hashed_password: hashed_password}, password)
