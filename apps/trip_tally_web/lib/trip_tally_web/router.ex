defmodule TripTallyWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {TripTallyWeb.Layouts, :root}
  ...
  if Application.compile_env(:trip_tally_web, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: TripTallyWeb.Telemetry
  ...
  scope "/", TripTallyWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TripTallyWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TripTallyWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TripTallyWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TripTallyWeb do
    ...
    live_session :current_user,
      on_mount: [{TripTallyWeb.UserAuth, :mount_current_user}] do
