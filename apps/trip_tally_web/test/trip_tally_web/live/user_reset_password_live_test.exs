defmodule TripTallyWeb.UserResetPasswordLiveTest do
  ...
  @new_valid_pass "New v@lid password"
  ...
  describe "Reset Password" do
    test "resets password once", %{conn: conn, token: token, user: user} do
      ...
      {:ok, conn} =
        ...
        |> form("#reset_password_form",
          user: %{
            ...
            "password_confirmation" => @new_valid_pass
          }
        )
        |> render_submit()
      ...
      assert Accounts.get_user_by_email_and_password(user.email, @new_valid_pass)
    end
